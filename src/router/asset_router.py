...
from src.schema.asset_schema import AssetSimpleView, AssetView,AssetCreate
...
@router.get("/{symbol}",status_code=status.HTTP_200_OK,response_model=AssetSimpleView)
